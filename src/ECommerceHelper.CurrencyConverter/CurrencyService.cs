...
namespace ECommerceHelper.CurrencyConverter {
    ...
    public class CurrencyService : ICurrencyService {
        ...
        //private helpers
        private Task<RatesStatus> getRatesStatusAsync() {
            ...
            if (_currentHttpContext != null) {
                ...
                if (cachedRatesStatusObj != null)
                    return TaskHelpers.FromResult((RatesStatus)cachedRatesStatusObj);
            }

            using (HttpClient httpClient = new HttpClient()) {

                return httpClient.GetStringAsync(Constants.BASE_CURRENCY_RATES_REQUEST_ADDRESS).Then(result => {
